var curriculumCards = [
	...
	
	{
		...
		items:[
			{
				text:"<b>C</b> (+Arduino IDE), <b>C++</b> <i class='icon-4'></i>"
			},
			{
				text:"<b>Java</b> (BackEnd, Android ,Spring (FW), Junit(FW)) <i class='icon-5'></i>"
			},
			{
				text:"<b>HTML</b>, <b>CSS</b> <i class='icon-3'></i>"
			},
			{
				text:"Vanila <b>JavaScript</b>, JQuery <i class='icon-3'></i>"
			},
			{
				text:"<b>NodeJs</b> (Express, Sails.js) <i class='icon-3'></i>"
			},
			{
				text:"FrontEnd JavaScript Frameworks (<b>AngularJs</b>, <b>ReactJs</b>) <i class='icon-4'></i>"
			},
			{
				text:"<b>Python</b> <i class='icon-2'></i>"
			}
		]
	},

	{
		title:"DIEGO SULZBECK VILLALOBOS",
		...
		items:[
			...
			{
				text:"<i class='fa fa-envelope'></i> diego.villa2@gmail.com "
			},
			{
				text:"<i class='fa fa-lg fa-linkedin-square'></i> <a href='https://www.linkedin.com/in/diego-sulzbeck-a0563bb5'>diego-sulzbeck-a0563bb5</a>"
			},
			{
				text:"<i class='fa fa-lg fa-facebook-square'></i> <a href='https://www.facebook.com/diego.sulzbeckvillalobos'>diego.sulzbeckvillalobos</a>"
			}
		]
	},
	...
	{
		title:"Linguagens de Baixo Nível e de Descrição de Hardware",
		parent:"conhecimentos",
		style:"list",
		items:[
			{
...

	{
		...
		subtitle:"Hackathon Ambev 2015, Novembro",
		items:[
			{
...

	{
		...
		items:[
			{
				text:"<b>Cofre eletrônico</b>, utilizando CI's da família TTL"
			},
			{
				text:"<b>Modulador Demodulador</b>, utilizando CI's da família TTL"
			},
			{
				text:"<b>Voltímetro</b>, utilizando CI's da família TTL"
			},
			{
...

	{
		...
		items:[
			{
				text:"Cursou até a <b>6ª série</b> do Ensino Fundamental no Colégio Espanhol <b>Miguel de Cervantes</b>, em São Paulo."
			},
			{
				text:"Concluiu o <b>Ensino Fundamental</b> e cursou os <b>primeiros anos do Ensino Médio</b> no <b>Colegio Internacional SEK Chile</b>, em Santiago, Chile."
			},
			{
				text:"Cursou e concluiu <b>3º ano</b> do Ensino Médio no <b>Colégio Stockler</b>, em São Paulo."
			}
		]
	},

	{
		...
		items:[
			{
				text:"Cursando <b>5º ano</b> da <b>Escola Politécnica da USP</b>, Curso de <b>Engenharia elétrica com ênfase em computação</b>."
			},
			{
				text:"Conclusão prevista <b>dez/2018</b>"
			}
		]
	},
	{
...

	{
		...
		items:[
			{
				text:"Participação no grupo extracurricular da Poli, Amudi, com o qual desenvolveu o projeto “Bixo”, um carrinho autônomo."
			},
			{
				text:"Estudos de violão e guitarra elétrica."
			},
		]
	},
	...
	{
		title:"",
		parent:"outras informacoes",
		style: "list",
		items:[
			{
				text:"Possui <b>nacionalidade espanhola</b>."
			},
			{
				text:"Morou <b>cinco anos em Santiago, Chile</b> (fev. 2005 a dez. 2009)."
			},
			{
				text:"Lecionou <b>aulas particulares</b> no primeiro ano da poli."
			}
		]
	}
];
